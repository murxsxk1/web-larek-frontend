...
// Базовый класс карточки без обработчиков
...
// 1. Карточка в каталоге - клик на всю карточку для открытия превью
...
// 2. Карточка превью - клик на кнопку для добавления в корзину
export class CardPreview extends BaseCard {
  ...
  constructor(container: HTMLElement, actions?: ICardActions) {
    ...
    // Обработчик только на кнопке, НЕ на всей карточке
...
// 3. Карточка в корзине - клик на кнопку удаления
export class CardBasket extends BaseCard {
  ...
  constructor(container: HTMLElement, actions?: ICardActions) {
    ...
    // СНАЧАЛА блокируем всплытие для всей карточки
    ...
    // ПОТОМ добавляем обработчик для кнопки удаления
