...
- [Классы представления (View)](#классы-представления-view)
...
Класс отвечает за управление корзиной товаров. Реализует интерфейс `ICardsData`.\
В полях класса хранятся следующие данные:
...
Базовый компонент для отображения карточки товара. Имеет три состояния отображения:
